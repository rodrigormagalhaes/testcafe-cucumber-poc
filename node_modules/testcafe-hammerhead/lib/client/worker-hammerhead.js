					...
					"native-methods.js": function (exports, module, require) {
						...
						var NativeMethods = /*#__PURE__*/function () {
						  ...
						  _proto.refreshDocumentMeths = function refreshDocumentMeths(doc, win) {
						    ...
						    this.querySelectorAll = docPrototype.querySelectorAll; // @ts-ignore

						    this.createHTMLDocument = win.DOMImplementation.prototype.createHTMLDocument; // @ts-ignore

						    if (doc.registerElement) this.registerElement = docPrototype.registerElement; // Event
						    ...
						    this.documentScriptsPropOwnerName = NativeMethods._getDocumentPropOwnerName(docPrototype, 'scripts'); // @ts-ignore
						    ...
						    this.documentReferrerGetter = win.Object.getOwnPropertyDescriptor(docPrototype, 'referrer').get; // @ts-ignore

						    this.documentStyleSheetsGetter = win.Object.getOwnPropertyDescriptor(docPrototype, 'styleSheets').get; // @ts-ignore

						    this.documentActiveElementGetter = win.Object.getOwnPropertyDescriptor(docPrototype, 'activeElement').get; // @ts-ignore
						    ...
						    this.documentCookieSetter = documentCookieDescriptor.set; // @ts-ignore

						    var documentDocumentURIDescriptor = win.Object.getOwnPropertyDescriptor(docPrototype, 'documentURI');
						    if (documentDocumentURIDescriptor) this.documentDocumentURIGetter = documentDocumentURIDescriptor.get; // @ts-ignore
